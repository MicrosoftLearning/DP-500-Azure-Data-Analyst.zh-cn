...
4. 在“Manage”页上，确保选择了“SQL Pools”选项卡，然后选择 sql*xxxxxxx* 专用 SQL 池，并使用其 &#9655; 图标启动它；确认在出现系统提示时进行恢复   。
5. 等待 SQL 池恢复。 这可能需要几分钟的时间。 使用“&#8635; 刷新”按钮定期检查其状态。 状态将在准备就绪时显示为“联机”。

### 查看数据库中的表

1. 在 Synapse Studio 中，选择“数据”页并确保“Workspace”选项卡已选定并包含“SQL 数据库”  类别。
...
1. 在“Data”页上，选择 sql*xxxxxxx* SQL 池，并在其“...”菜单中，选择“新建 SQL 脚本” > “空脚本”    。

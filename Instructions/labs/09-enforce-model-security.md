...
1. 在“建模”功能区选项卡上的“安全组”中，选择“通过以下身份查看”  。
...
3. 在“Power Query 编辑器”窗口的“查询”窗格（位于左侧）中，右键单击“Customer”查询，然后选择“复制”   。

    ![](../images/dp500-enforce-model-security-image45.png)

    由于“Customer”查询已包含连接数据仓库的步骤，因此复制它是开始开发新查询的有效方法。
...
2. 在“编辑关系”窗口的“交叉筛选方向”下拉列表中，选择“两个”  。

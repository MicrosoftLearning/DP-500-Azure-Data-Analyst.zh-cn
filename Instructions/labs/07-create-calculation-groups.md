...
1.  在“数据”窗格中，右键单击 Sales 表，然后选择“Create New度量值”  。
...
2.  在“Tabular Editor”窗口的左侧窗格中，右键单击 Tables 文件夹，然后选择“Create New”\>“Calculation Group”  。

    ![图形用户界面、文本、应用程序、表 描述自动生成](../images/image18.png)

3.  在左侧窗格中，将默认名称替换为“Time Intelligence”，然后按 Enter 。
...
6.  在“属性”窗格（位于右下角）中，选择“Name”属性，然后将其重命名为“Time Calculation”  。

    ![图形用户界面，应用程序 自动生成的描述](../images/image20.png)

7.  若要创建计算项，请右键单击 Time Intelligence 表，然后选择“Create New”\>“计算项”  。

    ![图形用户界面，应用程序 自动生成的描述](../images/image21.png)

8.  在左侧窗格中，将默认名称替换为“Current”，然后按 Enter 。

9.  在“Expression Editor”窗格（位于“属性”窗格上方）中，输入以下公式：
...
10. 在“Expression Editor”窗格工具栏中，选择第一个按钮以接受更改。
...
14. 在“属性”窗格中，将“Format String Expression”属性设置为 ： 
    ```
    "0.00%;-0.00%;0.00%"
    ```

    提示：Format String Expression可从 D:\\DP500\\Allfiles\\07\\Assets\\Snippets.txt 复制和粘贴。

    ![图形用户界面、文本、应用程序 描述自动生成](../images/image24.png)

15. 验证“Time Intelligence”计算组是否包含四个计算项。

    ![文本 描述自动生成](../images/image25.png)

16. 若要保存对 Power BI Desktop 模型的更改，请在“File”菜单上选择“Save” 。
...
现在，你将修改矩阵视觉对象，以使用“Time Calculation”列。

1.  在报表中，选择矩阵视觉对象。

2.  在“可视化效果”窗格的“值”井中，选择 X 以移除“Sales Amount”字段   。
...
5.  创建名为“Currency Conversion”的计算组。

    由于任务是重复的，因此提供的说明较简短。如有必要，可参考本练习的第一个任务中的步骤。

    ![文本 描述自动生成](../images/image36.png)

6.  将“Name”列重命名为“Converted Currency” 。

    ![文本 描述自动生成，具有低置信度](../images/image37.png)

7.  使用以下公式创建名为“Currency Conversion”的 Calculation Item：
...
8.  在“属性”窗格中，将“Format String Expression”属性设置为以下公式：
...
14. 在筛选器卡中，检查“Currency Conversion”值。
...
16. 在“Currency”切片器中，选择其他货币，然后在矩阵视觉对象中，注意更新后的值和格式。

17. 将“Currency”切片器还原回“美元”。
...
2.  在左窗格中，选择时间智能Calculation Group。

    ![文本 描述自动生成](../images/image43.png)

3.  在“属性”窗格中，将“Calculation Group Precedence”属性设置为 20。

    ![图形用户界面，应用程序 自动生成的描述](../images/image44.png)

    值越高，应用程序优先级越高。因此，首先应用优先级较高的计算组。

4.  将“Currency Conversion”计算组的Calculation Group Precedence设置为 10。

    ![图形用户界面、应用程序、表 描述自动生成](../images/image45.png)

    这些配置将确保稍后会进行“Time Intelligence”计算**。
